...
def init_db(model):
    ...
    sql = '''
                CREATE TABLE ckanext_frontpage (
                    id text NOT NULL,
                    title text,
                    name text,
                    content text,
    ...
    sql_upgrade_01 = (
        "ALTER TABLE ckanext_frontpage add column publish_date timestamp;",
        "ALTER TABLE ckanext_frontpage add column page_type Text;",
        "UPDATE ckanext_frontpage set page_type = 'page';",
    )
    ...
    sql_upgrade_02 = ('ALTER TABLE ckanext_frontpage add column extras Text;',
                      "UPDATE ckanext_frontpage set extras = '{}';")
    ...
    frontpage_table = sa.Table('ckanext_frontpage', model.meta.metadata,
