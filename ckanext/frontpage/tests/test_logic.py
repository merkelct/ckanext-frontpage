...
from ckanext.frontpage import db
...
class TestUpdate(helpers.FunctionalTestBase):
    ...
    def test_create_page(self):
        ...
        response = self.app.post(
            url=toolkit.url_for('frontpage_edit', page='/test_page'),
            params={
                'title': 'Page Title',
                'name': 'page_name',
            },
    ...
    @helpers.change_config('ckanext.frontpage.allow_html', 'True')
    def test_rendering_with_html_allowed(self):
        env = {'REMOTE_USER': self.user['name'].encode('ascii')}
        response = self.app.post(
            url=toolkit.url_for('frontpage_edit', page='/test_html_page'),
            params={
                'title': 'Allowed',
    ...
    @helpers.change_config('ckanext.frontpage.allow_html', False)
